  ...
  return (
    <EmployerOnboardingLayout currentStep={1}>
      ...
      <p className="mt-4 text-muted-foreground leading-relaxed max-w-xl">
        Many companies already have an InternHub profile. We'll look for yours, and if you use an applicant tracking system, we'll help find the jobs you've already posted.
      </p>
